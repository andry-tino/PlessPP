...
namespace PLessPP.Device.BandGestureFlowRetrieval
{
    ...
    /// <summary>
    /// <see cref="Exception"/> thrown when it was not possible to find a connection to the desired Band.
    /// </summary>
    public class BandNotFoundException : Exception
    {
        ...
        public BandNotFoundException(string message, Exception innerException) 
